...
<head>
  <meta charset="UTF-8">
  <title>DIVINNA Disco -Usuario-Perfil</title>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-10 form-section">
        <h4 class="mb-4">Usuario-Perfil</h4>
        <form>
          <div class="row mb-3">
            <div class="col-md-4">
              <label class="form-label">Código Función</label>
              <input type="text" class="form-control" name="codigo_funcion" required>
            </div>
            <div class="col-md-4">
              <label class="form-label">Nombre Función</label>
              <input type="text" class="form-control" name="nombre_funcion" required>
            </div>
            <div class="col-md-4">
